...
Public Class EuclideanAllocation
    ...
    Public ReadOnly Property Description() As String Implements Interfaces.IPlugin.Description
        Get
            Return "Assigns grid cells in the output image the value of the nearest target cell in the input image, measured by the Euclidean distance"
        End Get
    End Property
    ...
    Public Function Execute(ByVal ParameterArray() As String, ByVal worker As BackgroundWorker) As Object Implements Interfaces.IPlugin.Execute
        ...
        'target cell, and assigns the grid cell in the output image the value of the target cell. It is based on the efficient distance transform of Shih and Wu (2004), CV&IU.
        ...
        Try
            ...
            Allocation.HeaderFileName = OutputHeaderFile
            ...
            Output.HeaderFileName = Replace(OutputHeaderFile, ".dep", "temp3.dep")
            ...
            Output.MetadataEntries(Output.NumMetadataEntries + 1) = "Created by the EuclideanAllocation tool"
            ...
            Allocation.MetadataEntries(Allocation.NumMetadataEntries + 1) = "Created by the EuclideanAllocation tool"
            Allocation.MetadataEntries(Allocation.NumMetadataEntries + 1) = "Created on " & dateTimeInfo.ToString("F")
            Allocation.WriteHeaderFile()
